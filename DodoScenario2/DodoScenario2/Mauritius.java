...

{
    ...
    private static final String WORLD_NAME = "worldDodoRace3.txt";
    ...
    public List<SurpriseEgg> maakLijstMetSurpriseEieren(int aantal) {

        int waarde = ThreadLocalRandom.current().nextInt(1, 11);        

        return SurpriseEgg.generateListOfSurpriseEggs(aantal, this);
